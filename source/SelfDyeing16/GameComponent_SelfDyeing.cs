...
namespace SelfDyeing
{
    ...
    {
        public List<ApparelPolicy> Outfits = new List<ApparelPolicy>();
        public List<ApparelPolicy> AOutfits = new List<ApparelPolicy>();
        ...
        public void ExposeData()
        {
            ...
            {
                if (Outfits == null) Outfits = new List<ApparelPolicy>();
                if (AOutfits == null) AOutfits = new List<ApparelPolicy>();
        ...
        public bool ApparelOverlap(Pawn pawn, Apparel apparel)
        {
            ...
            //
            if (!Outfits.NullOrEmpty() && (pawn.outfits?.CurrentApparelPolicy == null || !Outfits.Contains(pawn.outfits.CurrentApparelPolicy)))
                return false;

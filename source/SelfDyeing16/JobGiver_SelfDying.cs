    ...
    public class JobGiver_SelfDyeing : ThinkNode_JobGiver
    {
                        ...
                        if (pattern.color == null)
                            switch (pattern.coloringMode)
                            {
                                case ColoringMode.Primary:
                                    color = comp.IdeoColor ? pawn.Ideo?.ApparelColor : pawn.story?.favoriteColor?.color;
                                    break;
                                case ColoringMode.Secondary:
                                    color = comp.IdeoColor ? pawn.story?.favoriteColor?.color : pawn.Ideo?.ApparelColor;
                                    break;
                                default:
                                    color = null;
                                    break;
        ...
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            if (apparel == null)
            {
                ...
                {
                    case PaintMode.Full:
                        primary = comp.IdeoColor ? pawn.Ideo?.ApparelColor : pawn.story?.favoriteColor?.color;
                        secondary = null;
                    ...
                    case PaintMode.TwoColor:
                        primary = thoughtpresent ? comp.IdeoColor ? pawn.story?.favoriteColor?.color : pawn.Ideo?.ApparelColor : comp.IdeoColor ? pawn.Ideo?.ApparelColor : pawn.story?.favoriteColor?.color;
                        secondary = thoughtpresent ? comp.IdeoColor ? pawn.Ideo?.ApparelColor : pawn.story?.favoriteColor?.color : null;
                        overriding = comp.OverrideMode == OverrideMode.Always || comp.OverrideMode == OverrideMode.Required && !thoughtpresent;
                        break;
                    default:
                        if (thoughtpresent)
